sap.ui.define([
	...
	return Opa5.extend("test.testNorthProducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["test/testNorthProducts/localService/mockserver"], function (mockserver) {
